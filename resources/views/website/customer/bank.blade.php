    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 page-header">
            ...
            <a href="{{ route('customer.dashboard') }}"
               class="btn btn-light border rounded-3 dashboard-btn">
                ...
                <div class="card border-0 shadow-sm rounded-4 h-100">
                    ...
                    <div class="card-body p-4">
                        ...
                        @else
                            ...
                            <div id="bankVerificationResult"
                                 class="verification-result d-none mt-4">
                                ...
                                <button type="button"
                                        id="saveBankBtn"
                                        class="btn btn-success w-100 rounded-3 py-2 mt-3">
                            ...
                            <div id="bankVerificationError"
                                 class="alert alert-danger rounded-3 d-none mt-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        @else
                            ...
                            <div id="upiVerificationResult"
                                ...
                                <button type="button"
                                        id="saveUpiBtn"
                                        class="btn btn-primary w-100 rounded-3 py-2 mt-3">
