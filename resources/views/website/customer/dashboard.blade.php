                ...
                <div class="dashboard-welcome">
                    ...
                    <div class="dashboard-avatar">
                        ...
                        @if(auth()->user()->profile_pic)
                            ...
                            <img src="{{ asset('storage/' . auth()->user()->profile_pic) }}" alt="{{ auth()->user()->name }}">
                ...
                <div class="dashboard-grid">
                    ...
                    <div class="dashboard-main">
                        ...
                        <div class="dashboard-card">
                            ...
                            <div class="quick-actions">
                                ...
                                <a href="{{ route('customer.packages') }}" class="quick-action">
                                ...
                                <a href="{{ route('customer.referrals') }}" class="quick-action">
                                ...
                                <a href="{{ route('customer.kyc') }}" class="back-dashboard-btn">
                    ...
                    <div class="dashboard-sidebar">
                        ...
                        <div class="dashboard-card profile-card">
                            ...
                            <a href="{{ route('customer.profile') }}" class="profile-btn">
                                View Profile
                            </a>
                        ...
                        <div class="dashboard-card referral-card">
                            ...
                            <a href="{{ route('customer.referrals') }}" class="dashboard-primary-btn">
                                View Referrals
