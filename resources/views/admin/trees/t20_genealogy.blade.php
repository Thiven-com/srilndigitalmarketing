...
<div class="tree-container">
    ...
    <div class="top-bar">
        ...
        <a href="{{ url('/admin/t20-genealogy-tree/ASK11122025') }}">
        ...
        @if ($upUser)
            ...
            <a href="{{ url("/admin/t20-genealogy-tree/$upUser?uptree=y") }}">
            ...
            <li>
                ...
                <ul>
                    ...
                    @foreach ($data['tree'] as $index => $tree)
                        @php
                            $count = \App\Models\T20Referral::where('placedunder_id', $tree->user_id)->count();
                        @endphp
                        <li>

                            <a href="{{ url("/admin/t20-genealogy-tree/$tree->user_id") }}">
