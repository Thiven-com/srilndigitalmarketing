            ...
            <div class="page-header d-flex flex-wrap align-items-center justify-content-between">
                <div class="add-item d-flex">
                    <div class="page-title">
                        ...
                        <h6>Leadership Team Overview</h6>
                    </div>
                </div>
                        ...
                        <table class="table table-bordered table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                @for($i = 1; $i <= 8; $i++)
                                    ...
                                    @php
                                        $bonusSetting = $bonusSettings[$i] ?? null;
                                        $members = $data['levelCounts'][$i] ?? 0;

                                        $income = 0;

                                        if ($bonusSetting && $bonusSetting->status == 'active') {
                                            $income = $members * $bonusSetting->bonus_amount;
                                            $totalIncome += $income;
                                        }
                                    @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            {{-- @if($bonusSetting && $bonusSetting->status == 'active')
                                                × {{ number_format($bonusSetting->bonus_amount) }}
        ...
        document.getElementById('searchForm').addEventListener('submit', function (e) {
            ...
            if (userid) {
                window.location.href =
                    "{{ url('admin/leadership-table') }}/" + userid;
            }
        });
    </script>
@endsection