        ...
        <div class="content">
            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                ...
                <div>
                    ...
                    <a href="{{ route('admin.reward-withdrawals.index') }}" class="btn btn-light">
                    ...
                    $withdrawal->id
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" name="settled_amount" class="form-control" value="{{ number_format(
                    $withdrawal->payable_amount,
                    2,
                    '.',
                    ''
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="settlement_reference" class="form-control" maxlength="255"
                                            placeholder="Enter UTR / transaction number" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="settlement_remark" class="form-control" maxlength="1000"
